document.addEventListener("DOMContentLoaded", () => {
  ...
  const sliderContent = [
    { name: "Serene Space", img: "./assets/1.jpg" },
    { name: "Gentle Horizon", img: "./assets/2.jpg" },
    { name: "Quiet Flow", img: "./assets/3.jpg" },
    { name: "Ethereal Light", img: "./assets/4.jpg" },
    { name: "Calm Drift", img: "./assets/5.jpg" },
    { name: "Subtle Balance", img: "./assets/6.jpg" },
    { name: "Soft Whisper", img: "./assets/7.jpg" },
  ];
